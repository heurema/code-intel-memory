# Code Intel Memory -- v0.3.0 Language Benchmark
...
| 21 | Go | code-intel-memory (self) | 2,259 | 6,561 | 10.5/12 | 87% | 2 |
...
### Go (code-intel-memory)

**Project**: `code-intel-memory` | **Repo**: self
